...
class TextBoxAndComboBoxWidget extends StatelessWidget {
  // final String textAddJob;
  const TextBoxAndComboBoxWidget({
    Key? key,
  }) : super(key: key);
        ...
        children: [
          Row(
            children: [
              ...
              Container(
                padding: const EdgeInsets.only(top: 2, bottom: 4, left: 170),
                child: Text(
                  'Loại',
                  style: AppTextStyles.h4.copyWith(
                      color: AppColors.orangeryYellow,
