...
class _SearchPageState<T> extends State<_SearchPage<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    String search = "";
    switch (SearchModel.typeSearch) {
      case TypeSearch.job:
        search = StringApp.searchJob;
        break;
      case TypeSearch.motel:
        search = StringApp.searchMotel;
        break;
      case TypeSearch.shop:
        search = StringApp.searchProduct;
    }
    return Semantics(
